    ...
    for (let i = 0; i < messages.length; i++) {
      ...
      try {
        await sendEmail(
          ...
          // Provider is chosen by EMAIL_PROVIDER (default "lovable"). These
          // options are only consulted on the Lovable path; sendUrl overrides
          // its default endpoint (https://api.lovable.dev).
