  ...
  theme: {
    ...
    extend: {
      ...
      keyframes: {
        ...
        "glow-pulse": {
          "0%, 100%": { boxShadow: "0 0 30px -10px hsl(38 92% 50% / 0.4)" },
          "50%": { boxShadow: "0 0 50px -10px hsl(38 92% 50% / 0.6)" },
        },
        "luxury-fade": {
      ...
      animation: {
        ...
        "luxury-fade": "luxury-fade 0.6s cubic-bezier(0.25, 0.46, 0.45, 0.94)",
