  ...
  return (
    <div className="min-h-screen bg-background">
      <div className="max-w-3xl mx-auto px-6 py-10">
        ...
        {/* Event Title & Info */}
        {editingHeader ? (
          <div className="bg-card rounded-lg p-5 border border-border shadow-card hover:shadow-card-hover transition-shadow duration-300 mb-8 space-y-3">
        ...
        {editingItems ? (
          <div className="space-y-2 mb-10">
            ...
            {editItems.map((item, idx) => (
              <div key={item.id || idx} className="bg-card rounded-lg p-4 border border-border shadow-card hover:shadow-card-hover transition-shadow duration-300 space-y-2">
          ...
          <div id="line-items" className="mb-10 scroll-mt-20">
            ...
            <div className="hidden sm:block bg-card rounded-lg border border-border shadow-card overflow-hidden">
              <Table>
                <TableHeader>
        ...
        {/* Total */}
        <div className="bg-card rounded-lg p-5 border border-border shadow-card hover:shadow-card-hover transition-shadow duration-300 mb-4 flex items-center justify-between">
        ...
        {/* Sign Section */}
        {!isAdmin && !signed ? (
          <div className="bg-card rounded-lg p-6 border border-border shadow-card hover:shadow-card-hover transition-shadow duration-300 mb-12">
        ...
        <section className="mb-12">
          ...
          <div className="bg-card rounded-lg p-5 border border-border shadow-card hover:shadow-card-hover transition-shadow duration-300">
