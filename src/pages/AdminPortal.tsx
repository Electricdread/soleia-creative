...
import { Loader2, LogOut, ExternalLink, Clock, Command, Users, FileText, Video, Zap, Send, Calendar, Palette, BookOpen, Eye, FolderOpen, MapPin, ArrowRight, Menu, X, Sun, Moon, Mail, HardDrive, MonitorPlay } from 'lucide-react';
...
const portals: PortalCard[] = [
  ...
  {
    title: 'Video Mapping',
    description: 'Upload the previz movie that plays across the 3D venue screens',
    icon: <MonitorPlay className="w-6 h-6 text-primary" />,
    href: '/admin/video-mapping',
  },
  {
  ...
  return (
    <div className="relative min-h-screen bg-background overflow-hidden">
      ...
      <main className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-10">
        ...
        <button
          onClick={() => navigate('/admin/video-mapping')}
          className="w-full mt-6 mb-2 flex items-center gap-4 rounded-xl border border-border bg-card hover:bg-muted/40 hover:border-primary/40 transition-all px-5 py-4 text-left group"
        >
          ...
          <div className="flex-1 min-w-0">
            <div className="font-display text-base text-foreground">Video Mapping</div>
            <div className="text-xs text-muted-foreground">Upload the previz movie that plays across the 3D venue screens</div>
          </div>
